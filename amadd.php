<html>
    ...
    <body>
        <h1 style="text-align: center;color:black;">ENETR THE MANGER DETAILS</h1>
        ...
        if(!empty($_POST['lname']))
        {
                ...
                if(!empty($_POST['dob']))
                {
					...
					mysqli_select_db($conn,"car");
						...
						$sql="select count(*) as c from manager ";
						...
						mysqli_query($conn,"INSERT INTO manager 										values('$mid','$_POST[fname]','$_POST[lname]','$_POST[dob]','$_POST[date]','$_POST[cid]','$password')");
...
<br><br><br><br><br><br><br><br><br><br><br><a href="adminview.php"><button name="back" style="width:10%;color=aqua;position: 'relative'; top:50%;bored-size:40px;border-radius:10pxborder: none;
    outline: none;
    height: 40px;
    background: aqua;
    color: back;
