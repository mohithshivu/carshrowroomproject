<html>
    ...
    <body>
        <h1 style="text-align: center;color:black;">MANAGER DETAILS FORM</h1>
        ...
        border-radius: 10px;" >
            <form method ="post" id="register" action="">
                ...
                <lable>Manager id:</lable><br/>
                <input type ="text" name="mid" placeholder="Enter the manager id " ><br/>
               ...
               //,
				...
				if(!empty($_POST['cpassword'])) 
					...
					mysqli_select_db($conn,"car");
							...
							mysqli_query($conn,"UPDATE  manager SET 									fname='$_POST[fname]',lname='$_POST[lname]',join_date='$_POST[date]',cid='$_POST[cid]',password='$_POST[npassword]' where manager_id='$_POST[mid]'");
...
?>
  ...
  <br><br><br><br><br><br><br><br><a href="managerview.php"><button  name="back" style="width:10%;color=aqua;position: 'relative'; top:50%;bored-size:40px;border-radius:10pxborder: none;
    outline: none;
    height: 40px;
    background: aqua;
    color: back;
