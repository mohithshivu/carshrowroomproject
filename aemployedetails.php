    ...
    <body>
	<h1 style="color: 'green';postion: 'center';">EMPLOYES DETAILS</h1>
    <table>
    <tr>
    <th>Employee_Id</th>
    <th>First Name</th>
    ...
    echo "<tr><td>" . $row["e_id"]. "</td><td>" . $row["fname"] . "</td><td>". $row["lname"] . "</td><td>". $row["dob"] . "</td><td>". $row["j_date"] . "</td><td>".$row["password"] . "</td></tr>";
    }
    echo "</table>";
    } else { echo "0 results"; }
    $conn->close();
