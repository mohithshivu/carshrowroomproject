...
<html>
    ...
    <body>
	<h1 style="text-align:center">THE TOTAL TURN OVER GAIN BY COMPANY </h1>
    ...
    // output data of each row
     ...
     echo "<tr><td style='text-align:center'>".$p1. "</td></tr>"."<br><br><br>";
	...
	left:50%;
    font-size: 18px;
    border-radius: 20px;"><a href="employeview.php"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>Back</a></button>
