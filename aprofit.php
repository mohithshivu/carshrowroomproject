...
<html>
    ...
    <body>
	<h1 style="text-align:center">THE TOTAL POFIT GAIN BY COMPANY </h1>
	...
	left:50%;
    font-size: 18px;
    border-radius: 20px;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i><a href="adminview.php">Back</a></button>
