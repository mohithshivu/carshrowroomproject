...
<html>
    ...
    <body>
	<h1 style="text-align:center">THE TOTAL SALARY ISSUED IS </h1>
    <form method="post" action="">
         <table>
    <tr>
    <th style='text-align:center'>TOTAL_SALARY</th>
   ...
   $query="UPDATE profit SET turn_over ='$tp1',total_salary='$ts1',com_profit='$p1' where total_salary= '$ts' ";
    ...
    // output data of each row
     ...
     echo "<tr><td style='text-align:center'>".$ts1. "</td></tr>"."<br><br><br>";
	...
	<br><br><br><a href="adminview.php"><button name="back" style="width:10%;color=aqua;position: 'relative'; top:50%;bored-size:40px;border-radius:10pxborder: none;
    outline: none;
    height: 40px;
    background: aqua;
    color: back;
	...
	left:50%;
    font-size: 18px;
    border-radius: 20px;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>Back</i></a></button>
